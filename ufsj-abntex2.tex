...
\begin{itemize}
    ...
    \item O submódulo de expressão, que define a árvore de expressão e as estruturas que podem ser usadas durante a passagem de mensagens para comunicar mudanças parciais;
