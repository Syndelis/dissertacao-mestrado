...
\begin{itemize}
    ...
    \item Simulação de modelos estocásticos com o algoritmo de Gillespie utilizando o mesmo editor baseado em nós. O software utilizará outra representação intermediária como entrada para a geração de código do modelo estocástico; 
